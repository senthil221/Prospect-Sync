...
create role prospect_import_worker login noinherit connection limit 4;
grant prospect_importer to prospect_import_worker;

create role prospect_operator nologin noinherit;
create role prospect_ops_worker login noinherit connection limit 2;
grant prospect_operator to prospect_ops_worker;

create role prospect_integrator nologin noinherit;
create role prospect_integration_worker login noinherit connection limit 2;
