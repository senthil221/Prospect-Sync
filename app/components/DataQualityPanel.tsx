...
export default function DataQualityPanel({ onMerged }: { onMerged: () => void }) {
  ...
  const indexHealthy = drift ? !drift.queued && !indexGap && !drift.staleInIndex : true;
