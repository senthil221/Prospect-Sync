...
function ProspectTableRow({ prospect, visibleDefinitions, selected, includeClient, canDeleteMaster, clientId, onSelect, onToggleSelected, onRemoveFromClient, onToggleVerified, onDelete }: { prospect: Prospect; visibleDefinitions: ColumnDefinition[]; selected: boolean; includeClient: boolean; canDeleteMaster: boolean; clientId?: string; onSelect: (prospect: Prospect) => void; onToggleSelected: (id: string) => void; onRemoveFromClient?: (prospect: Prospect) => Promise<void>; onToggleVerified?: (prospect: Prospect, verified: boolean) => void; onDelete: (id: string) => void }) {
