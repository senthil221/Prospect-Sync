...
export type ImportResumeDetail = { id: string; kind: "prospects" | "companies"; listId: string | null; clientId?: string | null; listName?: string; fileName: string; dataSource: string; status: string; ingestionMode?: string; committedRowOffset: number; totalRows: number | null; processedRows?: number; uniqueAdded?: number; duplicatesLinked?: number; processedBytes?: number; fileSizeBytes?: number | null; lastError?: string; headers: string[]; fieldMap: Record<string, string>; headerSignature: string; dateContacted?: string | null; mergeMode: CompanyMergeMode | null };
